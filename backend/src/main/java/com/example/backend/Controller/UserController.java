...
public class UserController {
    ...
    public ResponseEntity<?> registerUser(@RequestBody User user) {
        ...
        resource.add(WebMvcLinkBuilder.linkTo(WebMvcLinkBuilder.methodOn(UserController.class).registerUser(user))
                .withSelfRel());
    ...
    public ResponseEntity<?> registerUserByGoogle(@RequestBody GoogleSignUpDto gUser) {
        ...
        // Create HATEOAS response with self link
        EntityModel<User> resource = EntityModel.of(registeredUser);
        resource.add(WebMvcLinkBuilder.linkTo(WebMvcLinkBuilder.methodOn(UserController.class).registerUser(newUser))
                .withSelfRel());
        ...
        if (user == null) {
            ...
            if (Objects.equals(loginDto.getPassword(), user.getPassword())) {
                ...
                resource.add(WebMvcLinkBuilder
                        .linkTo(WebMvcLinkBuilder.methodOn(UserController.class).getUserByEmail(loginDto.getEmail()))
                        .withSelfRel());
    ...
    public ResponseEntity<?> getUserByEmail(@PathVariable String email) {
        ...
        // Add self link
        EntityModel<User> resource = EntityModel.of(user);
        resource.add(WebMvcLinkBuilder.linkTo(WebMvcLinkBuilder.methodOn(UserController.class).getUserByEmail(email))
                .withSelfRel());
    ...
    public ResponseEntity<?> getUserById(@PathVariable ObjectId Id) {
        ...
        resource.add(WebMvcLinkBuilder.linkTo(WebMvcLinkBuilder.methodOn(UserController.class).getUserById(Id))
                .withSelfRel());
    ...
    @PostMapping("/getusersnamesnotify")
    public ResponseEntity<?> getUsernamesnotify(@RequestBody List<String> ids) {
        ...
        for (String id : ids) {
            ...
            userOptional.ifPresent(user -> {
                ...
                userMap.put("id", user.getId()); // Ensure User has a `getId()` method
